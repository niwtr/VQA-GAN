...
from trainer_l1 import condGANTrainer as trainer
...
if __name__ == "__main__":
    ...
    if cfg.TRAIN.FLAG:
        ...
        algo.train()
    elif cfg.SAMPLING_TYPE == 'visualization':
        raise RuntimeError("`Visualization` sampling type is not supported in L1 setting.")
    else:
        assert cfg.SAMPLING_TYPE == 'normal'
